 ...
 */
static const int defnetactiverule   = 0;
#if TAB_PATCH
...
static char normbordercolor[]            = "#3C3C3C";
static char normfloatcolor[]             = "#3C3C3C";
...
static char titlenormbordercolor[]       = "#3C3C3C";
static char titlenormfloatcolor[]        = "#3C3C3C";

static char titleselfgcolor[]            = "#eeeeee";
static char titleselbgcolor[]            = "#893F3C";
static char titleselbordercolor[]        = "#d79921";
static char titleselfloatcolor[]         = "#d79921";

static char tagsnormfgcolor[]            = "#bbbbbb";
static char tagsnormbgcolor[]            = "#282828";
static char tagsnormbordercolor[]        = "#3C3C3C";
...
static char hidselfgcolor[]              = "#d79921";
...
static const Rule rules[] = {
	...
	RULE(.title = "alacritty^1", .tags = 1 << 0, .isterminal = 1)
	RULE(.class = "Brave-browser", .tags = 1 << 1, .netactiverule = 0)
	RULE(.class = "code-oss", .tags = 1 << 2)
	RULE(.class = "obsidian", .tags = 1 << 4)
	RULE(.class = "discord", .tags = 1 << 5)
	RULE(.class = "mpv", .tags = 1 << 7)
	RULE(.class = "Anki", .tags = 1 << 5, .monitor = 1)
	RULE(.class = "ClickUp", .tags = 1 << 8, .monitor = 1)
	#if SCRATCHPADS_PATCH
...
#define STACKKEYS(MOD,ACTION) \
	...
	{ MOD|Mod1Mask, XK_s,     ACTION##stack, {.i = PREVSEL } }, \
	{ MOD|Mod1Mask, XK_w,     ACTION##stack, {.i = 0 } }, \
	{ MOD|Mod1Mask, XK_e,     ACTION##stack, {.i = 1 } }, \
	{ MOD|Mod1Mask, XK_a,     ACTION##stack, {.i = 2 } }, \
	{ MOD|Mod1Mask, XK_z,     ACTION##stack, {.i = -1 } },
#endif // STACKER_PATCH
